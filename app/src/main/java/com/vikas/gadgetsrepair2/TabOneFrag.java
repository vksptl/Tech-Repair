...
public class TabOneFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.frag_tab_one, container, false);
        ...
        dbList1 = helpher1.getDataFromDBts();
        //dbList2= new ArrayList<DatabaseModel>();
        //dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewtas);
        ...
        mAdapter1 = new RecyclerSeven(getActivity(),dbList1);

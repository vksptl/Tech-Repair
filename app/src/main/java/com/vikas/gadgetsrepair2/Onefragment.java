...
public class Onefragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_onefragment, container, false);
       // expandableLayout1 = (ExpandableRelativeLayout) rootView.findViewById(R.id.expandableLayout1);
        ...
        dbList1 = helpher1.getDataFromDB();
        dbList2= new ArrayList<DatabaseModel>();
        dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewot);
        ...
        mAdapter1 = new RecyclerAdapterOne(getActivity(),dbList1);

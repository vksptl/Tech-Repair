 ...
 */
public class LapTwoFrag extends Fragment {
    public LapTwoFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.frag_lap_two, container, false);
       ...
       // helpher2 = new DatabaseHelpher(getActivity());
        ...
        dbList1 = helpher1.getDataFromDBb();
        //dbList2= new ArrayList<DatabaseModel>();
        //dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewls);
        ...
        mAdapter1 = new RecyclerThree(getActivity(),dbList1);

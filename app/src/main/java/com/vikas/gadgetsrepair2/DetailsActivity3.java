...
public class DetailsActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvname =(TextView)findViewById(R.id.name3);
        tvemail =(TextView)findViewById(R.id.email3);
        tvroll =(TextView)findViewById(R.id.roll3);
        tvaddress =(TextView)findViewById(R.id.address3);
        helpher = new DatabaseHelpher(this);
        dbList= new ArrayList<DatabaseModel>();
        dbList = helpher.getDataFromDBm();
        ...
        Toast.makeText(DetailsActivity3.this, dbList.toString(), Toast.LENGTH_LONG);
    }

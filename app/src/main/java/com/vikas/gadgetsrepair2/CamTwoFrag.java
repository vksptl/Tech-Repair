 ...
 */
public class CamTwoFrag extends Fragment {
    public CamTwoFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.frag_cam_two, container, false);
        ...
        dbList1 = helpher1.getDataFromDBcnl();
        //dbList2= new ArrayList<DatabaseModel>();
        //dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewcnl);
        ...
        mAdapter1 = new RecyclerEight(getActivity(),dbList1);

 ...
 */
public class MobTwoFrag extends Fragment {
    public MobTwoFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.frag_mob_two, container, false);
        ...
        dbList1 = helpher1.getDataFromDBs();
        //dbList2= new ArrayList<DatabaseModel>();
        //dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewlc);
        ...
        mAdapter1 = new RecyclerFive(getActivity(),dbList1);

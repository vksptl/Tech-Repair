 ...
 */
public class MobThreeFrag extends Fragment {
    public MobThreeFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.frag_mob_three, container, false);
        ...
        dbList1 = helpher1.getDataFromDBsb();
        //dbList2= new ArrayList<DatabaseModel>();
        //dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewlsb);
        ...
        mAdapter1 = new RecyclerSix(getActivity(),dbList1);

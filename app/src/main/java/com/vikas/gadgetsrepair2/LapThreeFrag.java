 ...
 */
public class LapThreeFrag extends Fragment {
    public LapThreeFrag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.frag_lap_three, container, false);
        ...
        dbList1 = helpher1.getDataFromDBm();
        //dbList2= new ArrayList<DatabaseModel>();
        //dbList2 = helpher2.getDataFromDBB();

        mRecyclerView1 = (RecyclerView)rootView.findViewById(R.id.recycleviewlm);
        ...
        mAdapter1 = new RecyclerFour(getActivity(),dbList1);
